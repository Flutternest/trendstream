  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return PageStorage(
      ...
      child: searchedShowsCount.map(
        data: (asyncData) {
          return _TvShowSearchGridWidget(
...
class _TvShowSearchGridWidget extends HookConsumerWidget {
  const _TvShowSearchGridWidget({
    super.key,
      ...
      child: AlignedGridView.count(
        ...
        itemBuilder: (BuildContext context, int index) {
          final AsyncValue<TvShow> currentShow = ref
              .watch(paginatedSearchTvShowsProvider(PaginatedSearchProviderArgs(
